    ...
    return (
      <div style={{ display: isShow === 'true' ? 'block' : 'none' }}>
        ...
        <div className={styles.aggreePopBox}>
          <h1>
            amischain Wallet Application Terms and Conditions
          </h1>
          <span className={styles.closeBtn} onClick={this.props.isPopFunc}>×</span>
          <div className={styles.popupCont}>
            <div>
              <b>1. </b>The following terms and conditions ("Terms") shall govern the relationship between amischain Foundation Ltd and you in relation to any wallet ("Wallet") for the storage of any Wancoin ("WAN") digital asset ("Digital Asset") applied for by you and issued to you by amischain Foundation Ltd ("amischain"). You acknowledge and accept every risk disclosed in these Terms. In these terms, any reference to amischain shall include amischain, its affiliates, officers, directors, agents, employees, contractors, suppliers, and any related bodies corporate.
            </div>
            <div>
            ...
            <div>
              <b>6. </b>Any third party that gains access to your private key may be able to gain access to your Digital Assets. You must take care not to respond to any inquiry regarding your purchase of Digital Assets, including but not limited to, email requests purportedly coming from any website purporting to be from amischain or a similar-looking domain. If you use a third-party product which allows you or third parties to access and hold the private keys, you acknowledge that amischain is not responsible for safeguarding such keys and it is not responsible for any loss of Digital Assets from theft, loss or mishandling of Digital Assets outside of its control. You will at all times maintain control of your private key and/or any account credentials associated with the Wallet, and will not share or disclose the private key or account credentials with any other party.
            </div>
            <div>
              <b>7. </b>amischain is not obliged to provide, does not provide or purport to provide, is not providing and shall not be deemed to have provided any advice or recommendation to you to use the Wallet or to hold any Digital Assets within the Wallet.
            </div>
            <div>
            ...
            <div>
              <b>11. </b>amischain shall not owe any legal or any other obligation to you in respect of your Digital Assets in your Wallet. Your Digital Assets are not in any way guaranteed by, nor do they constitute deposits or obligations of, amischain. Unlike cash reserves held in bank accounts or accounts with financial institutions, the Digital Assets held in your Wallet are not held with us and are so held by you entirely at your own sole risk and are not insured or protected by us or any party whether in Singapore or otherwise. You should consider specifically obtaining your own private insurance to insure such Digital Assets held by you. In the event of loss or loss of utility value, there is no public insurer or private insurance arranged by amischain to offer recourse to you.
            </div>
            <div>
            ...
            <div>
              <b>13. </b>Information about your Wallet and transactions involving your Wallet is recorded, and is publicly available, on the amischain blockchain, and may be accessible by the public. Any transaction involving your Wallet may be traced back to your Wallet.
            </div>
            <div>
            ...
            <div>
              <b>20. </b>The regulatory status of cryptographic tokens, blockchain and distributed ledger technology may be unclear or unsettled in many jurisdictions. It is difficult to predict how or whether regulatory agencies may apply existing regulation with respect to such technology and its applications, including to your Wallet, its related application and software, and your Digital Assets. It is likewise difficult to predict how or whether legislatures or regulatory agencies may implement changes to the relevant law and regulation. Such regulatory actions may negatively impact amischain as well as your ability to use your Wallet or access your Digital Assets.
            </div>
            <div>
              <b>21. </b>By entering into any transaction involving Digital Assets and your Wallet, you acknowledge and agree that you are aware of the tax implications (including the implications of any applicable income tax, goods and services or value added taxes, stamp duties and other taxes, withholding tax, and any tax reporting requirements) of acquiring, entering into, holding and disposing of the relevant Digital Assets. Any such tax or tax-related obligations, whether arising in Singapore or otherwise, shall be your sole and absolute responsibility. In the event that any such taxes are paid by or required to be paid by amischain, you shall reimburse amischain in respect of such taxes. You shall indemnify amischain against any tax penalties which may be imposed on amischain that result from or in any way relate to your failure to comply with your above-mentioned tax obligations.
            </div>
            <div>
            ...
            <div>
              <b>23. </b>You irrevocably authorise amischain to collect, use, and/or disclose information relating to you or your transactions in your Wallet to any of amischain’s agents, affiliates, or any other third parties selected by any of them, wherever situated, and/or to any person to (or through) whom amischain transfers or assigns (or may potentially transfer or assign) all or any of its rights, benefits and obligations under these Terms. amischain and any aforesaid recipient of information may collect, use, transfer and disclose any such information as required by or in furtherance of any obligation (contractual or otherwise) under or in connection to any law, court, regulator, legal process, self-regulatory bodies, governmental, regulatory, or tax authority. Such authority to collect, use and/or disclose shall continue notwithstanding that you no longer have any Digital Assets or maintain your Wallet.
            </div>
            <div>
              <b>24. </b>You will provide all documents and other information required by amischain in relation to your Wallet application, including but not limited to documents and information required to enable amischain to comply with its anti-money laundering and other legal or regulatory requirements. You represent and warrant that any such information, and any information contained in such documents, shall be accurate, true, and complete in all respects and you will immediately inform amischain if any of the above-mentioned information ceases to be accurate, true and complete.
            </div>
            <div>
              <b>25. </b>If the amischain software underlying the Wallet or its related applications is rapidly adopted, the demand for transaction processing and distributed application computations could rise dramatically and at a pace that exceeds the mining power available to the software. This could then result in a destabilization of such software and negatively impact your ability to access your Wallet or Digital Assets, or increase prohibitively your costs of accessing your Wallet or Digital Assets.
            </div>
            <div>
              <b>26. </b>If the amischain software underlying the Wallet or its related applications receives insufficient interest, whether because of competing, alternative software, or because the software has not met the expectations of users, or any other reason, the software may not be able to continue to operate or to operate as intended. This may also result in the destabilization of the amischain software and negatively impact your ability to access your Wallet or Digital Assets, or increase prohibitively your costs of accessing your Wallet or Digital Assets.
            </div>
            <div>
              <b>27. </b>The design, functions and features of your Wallet, as well as its related applications and software, shall be under constant development and amischain reserves the right to change such design, functions and features at any time.
            </div>
            <div>
              <b>28. </b>Neither amischain nor their respective officers, delegates or agents shall be liable for any loss or failure or delay in complying with their obligations under these Terms caused by force majeure, act of god, war, terrorism, industrial disputes, natural disaster, adverse weather conditions, failure of communication systems or any other cause beyond the control of amischain.
            </div>
            <div>
              <b>29. </b>Cryptographic tokens such as the Digital Assets, and applications that allow the holding of such Digital Assets, such as the Wallet, are a new and relatively untested technology. In addition to the risks noted above, there are other risks associated with your use of the Wallet and your purchase, holding and use of Digital Assets, including those that amischain cannot anticipate. Such risks may further materialise as unanticipated variations or combinations of the risks set out above. In addition, where more than one risk factor has effect simultaneously, this may have a compounding effect, which may not be predictable.
            </div>
            <div>
              <b>30. </b>To the extent permitted by applicable law, amischain shall not be liable for, and shall be indemnified and held harmless by, you from and against any loss, damage, expense or cost arising out of or in connection to any of your Digital Assets and any use by you of your Wallet, except if such loss, damage, expense or cost is a direct result of the gross negligence or wilful misconduct or fraud of amischain. To the extent permitted by applicable law, such loss, damage, expense, or cost shall include any and all damages of whatever kind, including indirect, incidental, special, exemplary, or consequential damages, including for loss of profits, goodwill and data. Some jurisdictions do not allow the exclusion of certain warranties or the limitation or exclusion of liability for certain types of damages. Therefore, some of the above limitations may not apply to you. Nothing in these Terms shall affect your statutory rights or exclude injury arising from gross negligence, wilful misconduct or fraud of amischain.
            </div>
            <div>
              <b>31. </b>These Terms shall be governed by and construed in accordance with Singapore law. You submit to the exclusive jurisdiction of the Singapore courts with regards to all proceedings relating to this these Terms and any of your dealings in the WAN ERC-20 tokens and WAN. Nothing herein shall limit the right of amischain to bring proceedings against you or your assets in the courts of any other jurisdiction.
            </div>
          </div>
